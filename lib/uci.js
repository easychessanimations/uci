...
class UciEngine{
    ...
    processLine(line){
        ...
        if(line.match(/^bestmove/)){            
            ...
            console.log(`thinking took ${elapsed}, bestmove ${this.info.bestmove}, onbestmove ${this.onbestmove}`)            
            if(this.onbestmove){                
                this.onbestmove()                
    ...
    go(props){
        ...
        this.onponderbestmove = props.onbestmove        
        ...
        if(this.pondering){
            if((this.positionSet.specifier == this.pondering.specifier)&&(this.positionSet.moves.join(" ") == this.pondering.moves.join(" "))){
                ...
                this.stop(_=>{                                    
                    ...
                    props.onbestmove = this.onponderbestmove
                    this.go(props)
                })
            }
            return
