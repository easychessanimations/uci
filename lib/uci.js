...
class UciEngine{
    ...
    spawn(){
        ...
        console.log(`spawned engine ${this.path} pid ${process.pid}`)
    }
    ...
    processLine(line){
        ...
        if(line.match(/^bestmove/)){            
            ...
            console.log(`thinking took ${elapsed}, bestmove ${this.info.bestmove}, onbestmove ${this.onbestmovereason}`)            
            if(this.onbestmove){                
                this.onbestmove()
            }            
            if(this.ponderAfter){
    ...
    setonbestmove(onbestmove, reason){
        console.log(`set onbestmove ${reason}`)
    ...
    go(props){
        ...
        if(this.running){
            console.log(`fatal trying to go while running`)
            return
        }
